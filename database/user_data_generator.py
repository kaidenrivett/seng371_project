...
for i in range(1, 101):
    ...
    #paediatrics, eye, ENT, dental, orthopaedics, neurology, cardiology, psychiatry, skin
...
with open('health_records.csv', mode='w', newline='') as file:
    writer = csv.DictWriter(file, fieldnames=['Patient ID', 'Age', 'Gender', 'Medical Condition', 'Medication', 'Dosage', 'Frequency'])
    writer.writeheader()
